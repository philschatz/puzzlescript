...
var FastBase64_encLookup: string[] = [];
...
function u32ToArray(i: number) { return [i & 0xFF, (i >> 8) & 0xFF, (i >> 16) & 0xFF, (i >> 24) & 0xFF]; }

function u16ToArray(i: number) { return [i & 0xFF, (i >> 8) & 0xFF]; }
...
function MakeRiff ( sampleRate: number, bitsPerSample: number, data: number[]) {
  ...
  wav = header.chunkId.concat(
    ...
    var dataURI = 'data:audio/wav;base64,' + FastBase64_Encode(wav);
