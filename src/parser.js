...
exports.GameLegendItemSimple = GameLegendItemSimple;
class GameLegendItemAnd extends GameLegendItemSimple {
}
exports.GameLegendItemAnd = GameLegendItemAnd;
class GameLegendItemOr extends GameLegendItemSimple {
}
exports.GameLegendItemOr = GameLegendItemOr;
...
exports.GameSoundSfx = GameSoundSfx;
...
exports.GameSoundSimpleEnum = GameSoundSimpleEnum;
...
exports.GameSoundNormal = GameSoundNormal;
...
exports.GameSoundMoveSimple = GameSoundMoveSimple;
...
exports.GameSoundMoveDirection = GameSoundMoveDirection;
...
exports.GameRuleLoop = GameRuleLoop;
        ...
        for (const bracketPair of this._bracketPairs) {
            ...
            for (const direction of directions) {
                ...
                for (const neighbor of bracketPair.neighbors) {
                    if (!curCell)
                        break; // If we hit the end of the level then this does not match
    ...
    if (m.succeeded()) {
        ...
        s.addOperation('parse', {
            ...
            colorName: function (_1) {
                return new HexColor(this.source, colors_1.lookupColorPalette(currentColorPalette)[this.sourceString.toLowerCase()]);
            },
